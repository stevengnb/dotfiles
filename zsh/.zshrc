...
# Power profiles
alias turbo='powerprofilesctl set performance'
alias balanced='powerprofilesctl set balanced'
alias silent='powerprofilesctl set power-saver'
alias profile='powerprofilesctl get'
...
alias gitak='batcat ~/.config/cheatsheets/git-aliases.md'
